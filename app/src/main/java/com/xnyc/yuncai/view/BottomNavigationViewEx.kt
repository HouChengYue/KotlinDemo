...
class BottomNavigationViewEx : BottomNavigationView {
    ...
    fun setupWithViewPager(viewPager: ViewPager?, smoothScroll: Boolean): BottomNavigationViewEx {
        ...
        mMyOnNavigationItemSelectedListener =
                MyOnNavigationItemSelectedListener(viewPager, this, smoothScroll, listener)
     ...
     * not cause a leak.
     */
    private class BottomNavigationViewExOnPageChangeListener(bnve: BottomNavigationViewEx) :
